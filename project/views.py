...
from project.models import project, User, OneTimeCode
from project.forms import projectForm, ReplyForm, RegistrationForm, VerifyForm
...
def advertisement_detail(request, post_id):
    ...
    return render(request, 'project/post.html', {'post': post, 'replies': replies, 'new_reply': new_reply, 'reply_form': reply_form})